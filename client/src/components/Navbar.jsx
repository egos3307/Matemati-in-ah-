    ...
    <header className="sticky top-0 z-50 w-full border-b border-primary/10 bg-white/80 backdrop-blur-md dark:bg-background-dark/80">
      ...
      <div className="bg-primary text-white py-1.5 px-3 sm:px-6 shadow-sm border-t border-white/10">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 sm:gap-4 text-xs font-bold">
          {/* Centered Badges and Text */}
          <div className="flex flex-1 items-center justify-center gap-2 sm:gap-3 overflow-x-auto no-scrollbar py-0.5 flex-wrap">
            ...
            <div className="flex items-center gap-2.5 whitespace-nowrap px-1.5">
            ...
            <Link
              to="/pdf-notlari"
              className="bg-white/25 hover:bg-white/35 px-3 py-0.5 rounded-full text-[10px] sm:text-[11px] font-black uppercase tracking-wider whitespace-nowrap shadow-xs flex items-center gap-1.5 text-white transition-all hover:scale-105"
            >
          ...
          {/* Right Stuck YouTube & Instagram Logoları (Mobilde ve Masaüstünde Sağa Yapışık) */}
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 ml-auto">
            ...
            <a
              ...
              className="flex items-center justify-center w-6.5 h-6.5 rounded-full bg-white/20 hover:bg-white/30 text-white transition-all hover:scale-110"
              aria-label="YouTube"
            >
