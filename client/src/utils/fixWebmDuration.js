/*
 * Client-side WebM metadata duration and seeking fixer.
 * Adapted from 'fix-webm-duration' package.
 */
...
export default function fixWebmDuration(blob, duration, options) {
        ...
        try {
            ...
            reader.onloadend = function() {
                try {
                    ...
                    console.error("Error in fixDuration parser:", ex);
                }
                resolve(blob);
            };
            reader.readAsArrayBuffer(blob);
        } catch (ex) {
            console.error("Error reading blob in fixWebmDuration:", ex);
            resolve(blob);
        }
    });
}
